...
**결정:** 역할별 MD 4종 + 기존 구현 스펙 유지

| 문서 | 역할 |
|------|------|
| `docs/wiki-domain.md` | 지식 도메인 정의 |
| `docs/journal.md` | 본 저널 |
| `docs/prd-party-viewer.md` | PRD·사양서 |
| `README.md` | 프로젝트 소개·실행·MCP |

구현 상세는 `pokemon-party-composition.md`, `party-viewer-implementation.md`에 유지 (이식용).
